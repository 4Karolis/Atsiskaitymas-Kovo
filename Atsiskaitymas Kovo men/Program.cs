...
namespace Atsiskaitymas_Kovo_men_
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //List<int> SukurtiBilietaiPo10Eur
            ...
            {
                case 1: Console.WriteLine("Pasirinkite bilieto tipa: [1] Po 10 €, [2] Po 20 €, [3] Po 30 €. Q - iseiti is programos.");
                    int pirktiPasirinkimas = int.Parse(Console.ReadLine());
                    break;
                    switch (pirktiPasirinkimas)
                    {
                        
                        case 1: Console.WriteLine("Iveskite kieki: ");
                            int kiekis1 = int.Parse(Console.ReadLine());
                            break;
                        case 2: Console.WriteLine("Iveskite kieki: ");
                            int kiekis2 = int.Parse(Console.ReadLine());
                            break;
                        case 3: Console.WriteLine("Iveskite kieki: ");
                ...
                case 2: Console.WriteLine("Pasirinkite bilieto tipa: [1] Po 10 €, [2] Po 20 €, [3] Po 30 €. Q - iseiti is programos.");
